...
public class FriendsActionSupport extends BaseClass{
	...
	public static void main(String[] args) {
		...
		sendFriendRequest.getRemainingSMSCredits("+917777774422");
		//sendFriendRequest.setSmsCount("+917777774411", "100");
...
System.out.println(uid);
	      ...
	      oneToOneCount = sentMessages < 20 ? sentMessages :  Math.min(sentMessages-20, receivedMessages) + 20;

	      transactionScore = (1 * oneToOneCount) + (0.2 * Math.min(gcSentMessages, gcReceivedMessages));

	      

	      int h2sEmLinked = (int) Math.floor((2.0*(Math.pow(transactionScore, 0.56))));
