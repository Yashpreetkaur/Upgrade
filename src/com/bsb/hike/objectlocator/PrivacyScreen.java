...
public class PrivacyScreen {
	...
	public static String  PRIVACY_TITLE_LBL= "Privacy";
	public static String  BLOCKED_LIST_LBL= "Blocked List";
	public static String  MANAGE_PEOPLE_YOU_HAVE_BLOCKED_LBL= "Manage people you've blocked";
	public static String  SHOW_LAST_SEEN_LBL= "Show Last Seen";
	...
	public static String CHANGE_YOUR_HIDDEN_MODE_PASSWORD = "Change your Hidden Mode password";
