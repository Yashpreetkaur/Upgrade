...
public class HomeScreen {
	...
	public static String START_A_NEW_CHAT_LBL = "Start a new chat"; //CONTENT DECRIPTION
	public static String SEE_ALL_LBL = "SEE ALL";
	public static String AMAZING_THINGS_LBL = "Amazing things you can do on hike";
	public static String HIKE_LOGO_ICON = "Navigate up";//CONTENT DECRIPTION
