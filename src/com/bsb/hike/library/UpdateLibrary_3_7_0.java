...
public class UpdateLibrary_3_7_0 extends UpdateLibrary {
	...
	public void updateProfile(){
		try {
			...
			//			UiObject scrollView = getChild(frame, Locators.CLASSNAME, "android.widget.ScrollView");
			//			UiObject r_Layout = getChild(scrollView, Locators.CLASSNAME, "android.widget.RelativeLayout",2);
			//			UiObject l_Layout = getChild(r_Layout, Locators.CLASSNAME, "android.widget.LinearLayout");
			//			UiObject emailField= getChild(l_Layout, Locators.CLASSNAME, "android.widget.EditText");
			//			clickOnElement(Locators.NAME, "Email");
